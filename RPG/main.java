...
public class main {
    ...
    public static void mensaje() {
        System.out.println("\n");
        System.out.println("TE QUEDAN MUCHAS AVENTURAS POR DELANTE VIAJERO, HA,HA,HA... SELECCIONA LO QUE DESEAS HACER AHORA...SI TE ATREVES");
    }
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (opcion == 4 && jugador1 != null) { // MOSTRAR ESTADÍSTICAS DEL JUGADOR
                ...
                System.out.println("RECOMENDACIÓN!! pasa por la tienda o prueba suerte en las cajas para aumentar tus estadísticas");
                ...
                if (opcion_lucha == 1) {
                    ...
                    System.out.println("Te recomendamos que pases por la tienda o pruebes suerte en las cajas para aumentar tus estadísticas");
                    System.out.println("****************************************************************************");
                ...
                while (true) {
                    ...
                    System.out.println("Podrás obtener llaves al derrotar enemigos... que los dioses de la fortuna te guien en tu camino");
