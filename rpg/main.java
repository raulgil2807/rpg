...
public class main {
    ...
    public static int pueblo() {
        ...
        System.out.println("1. Fuerte de los Guerreros de las minas (35/10 150 oros)");
        System.out.println("2. Aldea de Paladines de luz (20/15 300 oros)");
        System.out.println("3. Castillo Demoniaco de la Muerte (30/20 50 oros)");
        System.out.println("4. Ciudad Botín Elfica (22/8 500 oros)");
    ...
    public static void main(String[] args) {
        ...
        if (numero_pueblos == 1) {
            ...
            System.out.println( "******                                                                                              ******");
            System.out.println( "**********************************************************************************************************");
            System.out.println(  "***********     Se te regalarán 5 llaves para que puedas abrir cajas... aprovecha!!!!!        ***********");
